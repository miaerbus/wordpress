...
class CustomPostTypeController extends BaseController
{
    ...
    public function setSettings()
    {
        $args = array(
            array(
                'option_group' => 'my_plugin_cpt_settings',
                'option_name' => 'my_plugin_cpt',
    ...
    {
        $options = get_option('my_plugin_cpt');

        foreach ($options as $option) {

            // [] are different syntax to push an element to array
